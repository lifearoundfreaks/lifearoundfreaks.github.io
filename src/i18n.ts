...
const resources = {
    en: { translation: {
        ...
        "js info details": "Around a decade of familiarity with the language and around two years of various React projects.",
    ...
    ru: { translation: {
        ...
        "js info details": "Около десяти лет знакомства с языком и около двух лет различных проектов на React.",
        ...
        В какой-то момент мне, возможно, придется доработать свой парсер, поскольку
        ...
        "HTML/CSS design": "HTML/CSS дизайн",
        "(2019 august - 2020 september)": "(август 2019 - сентябрь 2020)",
        "(2021 november - 2022 february)": "(ноябрь 2021 - февраль 2022)",
    ...
    uk: { translation: {
        ...
        "js info details": "Близько десяти років знайомства з мовою і близько двух років різних проектів на React.",
        ...
        У якийсь момент мені, можливо, доведеться доробити свій парсер, оскільки
        ...
        "(2021 november - 2022 february)": "(листопад 2021 - лютий 2022)",
        "Education": "Освіта",
